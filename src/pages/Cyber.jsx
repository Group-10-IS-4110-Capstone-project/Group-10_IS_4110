...
<div className="overlap-wrapper">
  <div className="overlap">
    <div className="text-wrapper">Cyber</div>
    <div className="flex-container">
      <p className="text">
        <span className="span">
        
        Cybersecurity is a multidisciplinary field dedicated to safeguarding digital systems, networks, and data from unauthorized access, 
        cyberattacks, and potential threats. In an era where technology is integral to daily life and business operations, the protection of 
        sensitive information has become paramount. 
        <br></br><br></br>
        Cybersecurity measures encompass a range of strategies, including robust authentication 
        methods, network and endpoint security, encryption, and vigilant risk management. 
 <br></br><br></br>
        Organizations invest in firewall systems to control network traffic and prevent unauthorized access, while endpoint security ensures the protection of individual devices. Incident 
        response plans are crucial for swiftly detecting, containing, and recovering from security breaches. 
