...
import bloc from '../assets/bloc.jpg'
...
<div className="overlap-wrapper">
  <div className="overlap">
    ...
    <div className="flex-container">
      <p className="text">
        <span className="span">
        Blockchain technology is a decentralized and secure system that revolutionizes how data and transactions 
        are stored and managed. By distributing information across a network of computers, blockchain ensures 
        transparency and immutability while eliminating the need for intermediaries. Each transaction is cryptographically 
        secured and recorded in a block, which is then linked to the previous block, forming a chain. 

        <br></br><br></br>
        Each transaction is cryptographically 
        secured and recorded in a block, which is then linked to the previous block, forming a chain. This distributed ledger 
        technology enables trust among participants without relying on a central authority.
 <br></br><br></br>
        Beyond cryptocurrencies, blockchain finds applications in various sectors such as finance, supply chain management, healthcare, and voting systems, promising 
