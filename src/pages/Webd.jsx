  ...
  <div className="overlap">
    ...
    <div className="flex-container">
      <p className="text">
        ...
        Web development encompasses the creation and maintenance of websites and web applications, involving a 
        range of technologies, languages, and frameworks. Front-end development focuses on the user interface 
        and user experience, using languages like HTML, CSS, and JavaScript to design and implement the visual 
        elements of a website that users interact with directly. 
        <br></br><br></br>
        Back-end development involves server-side programming, database management, and server configuration to handle the logic and functionality 
        behind the scenes. Full-stack developers are proficient in both front-end and back-end development, 
        providing a holistic approach to building web solutions. 
 <br></br><br></br>
        Web development has become an integral part of businesses and individuals seeking an online presence, as websites serve as primary touchpoints for 
        information dissemination, e-commerce, communication, and more. 
        </span>
      </p>
